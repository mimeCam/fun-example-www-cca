...
**Core killer feature:** Posts age and die on a decay clock; readers revive them. Author seals conviction (HMAC) at publish; readers challenge. Verdicts close the accountability loop and drive the batting average. The Prediction Vault extends this — every falsifiable claim across all posts, sealed by reality.
