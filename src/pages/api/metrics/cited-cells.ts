...
//
// SLA: sub-50ms on SQLite — three indexed scalar queries + one group-by.
//
// Credits: Mike (napkin §5 shared metric definition), Paul (windowed
//          ratio), Elon (baseline-before-target), Sid (helpers ≤ 10 LOC).
...
function shape(snap: RoundTripBaseline): Record<string, unknown> {
  return {
