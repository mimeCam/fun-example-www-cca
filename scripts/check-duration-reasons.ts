 ...
 *  seal-ceremony.css joined in v160 (Mike napkin v160, Krystle sprint) —
 *  literals there were collapsed into aliases to `motion.css` / `tokens.css`
 *  (polymorphic win, Mike §3: one reason, many sites).
